...
export type AIProvider = "xai"; // Only xAI now
export const AI_PROVIDER: AIProvider = "xai"; // Hardcode to xAI
...
const DEFAULT_REASONING_EFFORT: "low" | "high" | undefined = "low"; // Default to low reasoning effort
...
export function getAIConfig() {
    ...
    let reasoningEffort: "low" | "high" | undefined = DEFAULT_REASONING_EFFORT;
