...
export const readFileTool = {
    ...
    description: "Read the complete contents of one or more files from the workspace filesystem. " +
    ...
    inputSchema: ReadFileJsonSchema, // Cast as any to fit ToolDefinition if needed
