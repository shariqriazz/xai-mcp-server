...
export const saveAnswerQueryDirectTool = {
    ...
    description: `Answers a natural language query using only the internal knowledge of the configured xAI model (${modelIdPlaceholder}), does not use Live Search, and saves the answer to a file. Requires 'query' and 'output_path'.`,
