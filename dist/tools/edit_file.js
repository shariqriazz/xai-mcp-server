...
export const editFileTool = {
    ...
    description: "Make line-based edits to a text file in the workspace filesystem. Each edit attempts to replace " +
    ...
    inputSchema: EditFileJsonSchema, // Cast as any if needed
