...
export const getFileInfoTool = {
    ...
    description: "Retrieve detailed metadata about a file or directory within the workspace filesystem. " +
    ...
    inputSchema: GetFileInfoJsonSchema, // Cast as any if needed
