...
export const directoryTreeTool = {
    ...
    description: "Get a recursive tree view of files and directories within the workspace filesystem as a JSON structure. " +
    ...
    inputSchema: DirectoryTreeJsonSchema, // Cast as any if needed
